            ...
            <div class="flex flex-col h-full lg:h-[91.5vh] px-5 pt-5">
              <header class="mb-10 max-lg:mb-6 max-sm:mb-8">
                ...
                >
                  <div class="flex items-center">
                    ...
                    >
                    {{ paginatedUsers.length }} agencies
                    </h3>
                    <button
              ...
              <div class="relative overflow-x-auto rounded-md mr-9">
                ...
                >
                  ...
                  <tbody>
                    <template v-for="contact in paginatedUsers" :key="contact._id">
              ...
              <footer class="flex items-center justify-between mt-5 py-3  mb-2">
                ...
                <nav aria-label="Page navigation example">
                  <div v-if="totalPages > 1" class="flex justify-center mt-5 cursor-pointer">
                       
                       <a v-if="currentPage > 1" @click="changePage(currentPage - 1)"
                           class="py-2 pl-1 pr-2 ml-0 text-base leading-tight rounded-l-lg hover:text-gray-700 max-xl:text-sm cursor-pointer">
                           <svg
                         xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 24 24"
                         fill="currentColor"
                         aria-hidden="true"
                         class="w-5 h-5 max-xl:w-4 max-xl:h-4 inline "
                       >
                         <path
                           fill-rule="evenodd"
                       ...
                       <template v-for="page in displayedPages" :key="page">
                           <a @click="changePage(page)"
                               :class="['mt-1 mr-1 px-2 py-1 font-medium leading-tight rounded-full hover:bg-yellow-400 max-xl:text-sm  focus:outline-none', { 'bg-yellow-300 text-black': page === currentPage, ' text-gray-500': page !== currentPage }]">
                               {{ page }}
                       </a>
                       </template>

                       <a v-if="currentPage < totalPages" @click="changePage(currentPage + 1)"
...
console.log('Data', paginatedUsers.value)
